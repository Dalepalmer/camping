//mapportlet , moved for easy debugging only
...
function loadGoogleMap() {
  ...
  google.maps.event.addListenerOnce(map, "projection_changed", function () {
    var zoomLevel = 0;
    try {
      if (areaBounds != null) map.fitBounds(areaBounds);
    ...
    //map.savePosition();
    // Create the EWindows
    var E_STYLE_FSyellow = new EStyle(
      homeUrl + "/img/",
      "FSyellow_close.gif",
      new google.maps.Size(16, 16, "px", "px"),
      "FSyellow_stem.png",
      new google.maps.Size(43, 39, "px", "px"),
      4,
      20,
      39,
      7,
      "FSyellow_top.png",
      new google.maps.Size(302, 34, "px", "px"),
      "FSyellow_mid.png",
      new google.maps.Size(302, 2, "px", "px"),
      "FSyellow_bot.png",
      new google.maps.Size(302, 76, "px", "px"),
      -7,
      "FSyellow",
      new google.maps.Point(-60, -1),
      "obj_FSyellow"
    );
    var E_STYLE_FSrec = new EStyle(
      homeUrl + "/img/",
      "FSrec_close.png",
      new google.maps.Size(20, 20, "px", "px"),
      "FSrec_stem.png",
      new google.maps.Size(69, 49, "px", "px"),
      30,
      47,
      53,
      27,
      "FSrec_top.png",
      new google.maps.Size(304, 65, "px", "px"),
      "FSrec_mid.png",
      new google.maps.Size(304, 6, "px", "px"),
      "FSrec_bot.png",
      new google.maps.Size(304, 82, "px", "px"),
      -10,
      "FSrec",
    ...
    if (!browserIE()) {
      //Layer images look too bulky in ie
    ...
    google.maps.event.addListener(map, "idle", function () {
      ...
      if (mode == "level" && oldmode == "all") wipeAllMarkers = true;
...
function firstLoad(mode, cBox) {
  var url = markerServletHome + "/MarkerServlet";
  var params =
    "mode=" +
    mode +
    "&level=" +
...
function layerControl(layerControlDiv, map) {
  ...
  controlUI.innerHTML =
    'Layers <img src="https://maps.gstatic.com/mapfiles/arrow-down.png">';
  ...
  google.maps.event.addDomListener(controlUI, "click", function () {
    controlDropdown.style.display =
      controlDropdown.style.display != "none" ? "none" : "";
  });
...
function addLayer(layerId, checked, dropdownForm) {
  ...
  if (checked) domInput.checked = "checked";
...
function changeLayer(layerId) {
  ...
  if (layerId == "Photos") {
    if (document.getElementById("Photos").checked == true) {
      if (photoLayer.getMap() == null) {
        photoLayer.setMap(map);
      }
    }
