//marker.js content. Moved for easy debugging purpose
...
function infoContent(attr, infoType, iconImg) {
  ...
  if (infoType == "FS") {
    ...
    winfooter =
      "Go to the <a href='" +
      createSiteLink(attr.ISFOREST, attr.SHORTURL, attr.ID) +
      "'> " +
      attr.NAME +
      " " +
      " page</a>";
    ...
    winbody =
      "<p>More contents will be added.<br/>Please check back later.</p>";
    winfooter =
      "Go to the <a href='" +
      createSiteLink(attr.ISFOREST, attr.SHORTURL, attr.ID) +
      "'>" +
    ...
    subtitle = "<label></label><span></span>";
    winbody =
      "<div id='ewin_activityList'>" +
      getActListHtml(attr.ACTLIST) +
      "</div><br clear='all' /><p>" +
      attr.DESCRIPTION +
      "</p>";
    winfooter =
